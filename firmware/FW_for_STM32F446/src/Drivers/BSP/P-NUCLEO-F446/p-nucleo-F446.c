...
******************************************************************************
*/
#ifndef P_NUCLEO_F4_C
#define P_NUCLEO_F4_C 
...
void HW_IF_ADC_Init(void)
{
  ...
  usbpdm1_hadc.Init.ExternalTrigConv = ADC_SOFTWARE_START;
  usbpdm1_hadc.Init.DataAlign = ADC_DATAALIGN_RIGHT;
  usbpdm1_hadc.Init.NbrOfConversion = USBPD_ADCn + USBPD_ADC_INT_CHANNEL;
