...
void SystemClock_Config(void)
{
  ...
  { }
  LL_RCC_PLL_ConfigDomain_SYS(LL_RCC_PLLSOURCE_HSI, LL_RCC_PLLM_DIV_2, 30, LL_RCC_PLLR_DIV_2);
  ...
  { }
  LL_RCC_PLLSAI1_ConfigDomain_ADC(LL_RCC_PLLSOURCE_HSI, LL_RCC_PLLSAI1M_DIV_2, 8, LL_RCC_PLLSAI1R_DIV_2);
